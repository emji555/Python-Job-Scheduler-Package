...
from package_name.app import App, configure


def create_app(**config: Any) -> App:
    """Configure PACKAGE_NAME during FastAPI lifespan startup."""
...
def install_lifespan(fastapi_app: Any, **config: Any) -> Any:
    ...
    async def lifespan(app: Any):
        ...
        app.state.package_name = package_app
...
def get_app(request: Any) -> App:
    return request.app.state.package_name  # type: ignore[no-any-return]
