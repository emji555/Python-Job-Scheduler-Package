...
from workloom.core.events import JobDispatched
from workloom.core.registry import JobDefinition, detect_async, qualify_name
from workloom.core.result import JobHandle
from workloom.typing import P, R
...
class Job(Generic[P, R]):
    ...
    def __init__(self, definition: JobDefinition, *, app: Any | None = None) -> None:
        ...
        self.__module__ = getattr(definition.func, "__module__", "workloom")
